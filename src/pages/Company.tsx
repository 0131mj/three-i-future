        ...
        <Flex.ColCenter className={'company'}>
            ...
            <section>
                ...
                <Flex.Col Tag={'ul'}>
                    <li>종합상황실 구축 컨설팅</li>
                    <li>디지털 정보처리</li>
                    <li>AI 기반 영상인식 솔루션</li>
                    <li>통합 CCTV 구축 및 모니터링</li>
                </Flex.Col>
            </section>
            <section>
                <h3>경영 전략</h3>
                <h4>"고객만족"</h4>
                <Flex.Between style={{justifyContent: "space-around"}}>
                    <Flex.Col>
                        <h5>연구개발</h5>
                        ...
                        센터 구축 표준지침과의 연계를 위한 제안<br/><br/>

                        <h5>철저한 사업관리</h5>
                        지속적이고 철저한 관리체계 수립<br/>
                        품질보증방안 및 일정관리 방안 제시<br/><br/>
                    </Flex.Col>
                    <Flex.Col>
                        <h5>안전관리</h5>
                        통합일정관리를 통한 공기지연 사전예방<br/>
                        숙련공 투입으로 안전사고 사전예방<br/><br/>

                        <h5>완벽한 교육 및 사후관리</h5>
                        구축 설비 전반에 대한 운영교육 및 기술이전<br/>
                        센터 구축 운영을 위한 전문교육 및 사후관리<br/><br/>

                        <h5>품질관리</h5>
                        정확한 시공에 따른 철저한 품질 관리<br/>
                        최고의 장비 선정과 최고의 자재선정<br/><br/>
                    </Flex.Col>
                </Flex.Between>
            ...
            <section>
                ...
                <Flex.ColCenter>
                    ...
                    <p style={{marginBottom: 50}}>영상분석 및 전송기술 개발 성공으로
                        영상처리 선도기업 도약</p>
