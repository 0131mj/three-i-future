    ...
    return (
        <Flex.ColCenter>
            ...
            <section>
                <h3>스마트 영상분석기</h3>
                <ul>
                    <li>제공되는 실시간 영상입력에 대한 지능형 알고리즘
                        적용
                    </li>
                    <li>AI 기반 영상분석, 통신, 데이터 처리
                        기능을 구현할 수 있는 스마트 영상감지기
                    </li>
                </ul>
                <h4>스마트 영상분석기</h4>
                <h5>3IF-SRC-AI</h5>
                <Flex.Center style={{padding: "2rem 0"}} gap={24}>
